...
def test_105486bd_test_health_check():
    """test health check"""
    try:
...
def test_105486bd_test_item_reading():
    """test item reading"""
    try:
...
def test_105486bd_test_empty_item_creation():
...
def test_105486bd_test_wrong_method():
    """test wrong method"""
    try:
        # Prepare request payload (only when we have one)
...
def test_105486bd_test_unauthorized_access():
